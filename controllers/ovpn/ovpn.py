...
class Ovpn(Common):
    ...
    def ovpn(self):
        ...
        directory = '/home/uvpn/vpn_access'
        ...
        subprocess.Popen(['python3.5', script_file, '-job_id', str(job_id), '-callback_url', str(callback_url), '-data_url', str(data_url), '-token', str(token)])
